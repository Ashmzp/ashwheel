import React, { useState, useEffect, useCallback } from 'react';
    ...
    const BookingForm = ({ booking, isEditing, onSave, onCancel, isSaving, isLoading }) => {
      ...
      const { formData, setFormData, resetForm, customFields, setCustomFields } = useBookingStore();
      ...
      const initializeForm = useCallback(async () => {
        try {
          ...
          setCustomFields(bookingSettings.customFields || []);
      ...
      }, [isEditing, booking, toast, setCustomFields, setFormData, resetForm]);
      ...
      const handleSubmit = async (e) => {
        ...
        const dataToSave = {
          ...formData,
          id: isEditing ? booking.id : uuidv4(),
        };
